  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        <!-- <el-select v-model="selectValue" placeholder="请选择" class="selectRXX" @change="selectChage">
          <el-option
...
export default {
  ...
  mounted () {
    sessionStorage.setItem('station', this.$route.params.id);
    this.sysName=sessionStorage.getItem('station');
     this.$router.push({ path: '/DrawingShow' });
